 ...
 */
private fun shareSoldDessertsInformation(intentContext: Context, quantitySold: Int, totalRevenue: Int) {
    val sendIntent = Intent().apply {
        action = Intent.ACTION_SEND
        putExtra(
            Intent.EXTRA_TEXT,
            intentContext.getString(R.string.share_text, quantitySold, totalRevenue)
        )
        type = "text/plain"
    }
...
private fun DessertClickerApp(
    dessertViewModel: DessertViewModel = viewModel(factory = DessertViewModel.Factory)
) {
